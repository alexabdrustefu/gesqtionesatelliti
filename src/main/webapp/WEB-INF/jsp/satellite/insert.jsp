				...
				<div class='card border border-warning'>
					...
					<div class='card-body'>
						...
						<form:form modelAttribute="insert_satellite_attr" method="post"
							...
							<div class="col-md-6">
								...
								<spring:bind path="denominazione">
									...
									<input type="text" name="denominazione" id="denominazione"
										...
										placeholder="Inserire il denominazione"
							...
							<fmt:parseDate value="${insert_satellite_attr.dataLancio}"
							...
							<div class="col-md-3">
								...
								<spring:bind path="dataLancio">
									<input class="form-control ${status.error ? 'is-invalid' : ''}btn btn-outline-success border border-warning"
							...
							<fmt:parseDate value="${insert_satellite_attr.dataRientro}"
								pattern="yyyy-MM-dd" var="localDateToBeParsed" type="date" />
							<fmt:formatDate pattern="yyyy-MM-dd"
								value="${localDateToBeParsed}" var="parsedDate" />
							<div class="col-md-3">
								...
								<spring:bind path="dataRientro">
									<input class="form-control ${status.error ? 'is-invalid' : ''}btn btn-outline-danger border border-warning"
							...
							<div class="col-md-3">
								...
								<spring:bind path="stato">
									<select class="form-select ${status.error ? 'is-invalid' : ''}btn btn-outline-primary"
										id="stato" name="stato" required>
										<option value="" selected>- Selezionare -</option>
										<option value="IN_MOVIMENTO"
											${insert_satellite_attr.stato == 'IN_MOVIMENTO'?'selected':''}>IN_MOVIMENTO</option>
										<option value="FISSO"
